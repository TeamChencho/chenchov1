 ...
 *
 * @memberof ModeloUsuariosAdviser
 * 
 * @param {String} idAdviser Id único del moderador, para buscar sus grupos
...
exports.ObtenerTodosLosGrupos = function (idAdviser) {
    return new Promise(function (resolve, reject) {
        exports.AsyncObtenerTodosLosGrupos(idAdviser, function (grupos, error) {
            if (!error) {
...
/**
 * Función asíncrona recursiva que manda llamar desde la base de datos todos los grupos pertenecientes a un moderador que hay en el sistema
 *
 * @memberof ModeloUsuariosAdviser
 *
 * @param {String} idAdviser Id único del moderador, para buscar sus grupos
 ...
 *
 */
exports.AsyncObtenerTodosLosGrupos = async (idAdviser, callback) => {
...
exports.AsyncObtenerTodosLosProfesores = async (index, dataArray, callback) => {
    ...
    inquery.equalTo("clave", "MODERADOR")
...
/**
 * Función que permite conexión con controladores y eliminar un grupo de un moderador en la base de datos
 *
 * @memberof ModeloUsuariosAdviser
 *
 * @param {String} idGrupo Id único del grupo, para ser buscado en la base de datos
 * @param {String} idModerador Id único del moderador, para ser buscado en la base de datos
 *
 */
exports.EliminarGrupo = function (idGrupo, idModerador) {
    return new Promise(function (resolve, reject) {
        exports.AsyncObtenerGrupo(idGrupo, function (grupo, error) {
...
/**
 * Función asíncrona que manda llamar desde la base de datos un grupo a través de su Id único
 * @memberof ModeloUsuariosAdviser
 *
 * @param {String} idGrupo Id único de identificación del usuario de administración
 * @param {function} callback Función callback para devolver la información
 */
exports.AsyncObtenerGrupo = async (idGrupo, callback) => {
    var Grupos = Parse.Object.extend("Grupos")
    var query = new Parse.Query(Grupos)

    query.equalTo("objectId", idGrupo)
    query.equalTo("exists", true)
...
/**
 * Función asíncrona que manda llamar desde la base de datos un grupo perteneciente a un moderador a través de su Id único
 * @memberof ModeloUsuariosAdviser
 *
 * @param {String} idGrupo Id único de identificación del usuario de administración
...
/**
 * Función que permite conexión con controladores y archivar un grupo en la base de datos
 *
 * @memberof ModeloUsuariosAdviser
 *
...
/**
 * Función que permite conexión con controladores y editar un grupo en la base de datos
 *
 * @memberof ModeloUsuariosAdviser
...
exports.EditarGrupo = function (data) {
    return new Promise(function (resolve, reject) {
        ...
        exports.AsynObtenerGrupo(objectId, function (grupo, error) {
            if (!grupo) {
...
/**
 * Función que permite conexión con controladores y obtener usuarios de un grupo
 *
 * @memberof ModeloUsuariosAdviser
...
/**
 * Función asíncrona que manda llamar desde la base de datos, a los alumnos que pertenecen a un grupo por su Id único
 * @memberof ModeloUsuariosAdviser
 *
...
/**
 * Función que permite conexión con controladores y obtener los detalles del un grupo por su Id único
 *
 * @memberof ModeloUsuariosAdviser
 * @param {String} idGrupo Id único del grupo
 */
exports.ObtenerGrupo = function (idGrupo) {
    return new Promise(function (resolve, reject) {
        exports.AsynObtenerGrupo(idGrupo, function (grupoEncontrado, error) {
            ...
            var data = grupoEncontrado
            resolve({ type: "BUSCAR", data: data, error: null })
...
/**
 * Función asíncrona que manda llamar desde la base de datos, al grupo a consultar
 * @memberof ModeloUsuariosAdviser
 *
 * @param {String} idGrupo Id único de identificación del grupo
 * @param {function} callback Función callback para devolver la información
 */
exports.AsynObtenerGrupo = async (idGrupo, callback) => {
    var Grupos = Parse.Object.extend("Grupos")
    var query = new Parse.Query(Grupos)
...
/**
 * Función que permite conexión con controladores y agregar un grupo con los diferentes moderadores 
 *
 * @memberof ModeloUsuariosAdviser
 * @param {Object} data JSON serializado de la forma con el contenido del usuario de administración
 */
exports.AgregarGrupo = function (data) {
    return new Promise(function (resolve, reject) {
        exports.BuscarCodigoGrupo(data["codigoGrupo"], function (grupo, error) {
            ...
            object.save().then((objecto) => {
                ...
                arregloModeradores.push(data["currentUser"])
...
exports.AsyncObtenerDatosGrupo = async (idGrupo, callback) => {
    var Permisos = Parse.Object.extend("Permisos");
    var permiso = new Parse.Query(Permisos)
    permiso.equalTo("clave", "MODERADOR")
                    ...
                    exports.AsyncBuscarAlumnoGrupo(data.grupoPtr, usuario, function (usuarioEnGrupo, error) {
                        ...
                        if (usuario) {
                            if (usuario.get("permisoPtr").get("clave") != 'ALUMNO') {
                                return resolve({ type: "AGREGAR", data: null, error: "This user cannot be added, as the mail already exists with a different permission" })
                            }
                        }
                        if (!usuario) {
...
exports.AsyncBuscarAlumnoGrupo = async (idGrupo, usuario, callback) => {
    var Grupos = Parse.Object.extend("Grupos")
    var grupo = new Grupos()
    grupo.id = idGrupo
    ...
    gruposUsuarios.equalTo("usuarioPtr", usuario)
 ...
 * @returns {Promise<Object>} JSON con el tipo de consulta, los datos de vuelta y el error en caso de existir
 */
exports.ImportarAlumnos = async function (pathArchivo, grupoId, fullUrl) {
    return new Promise(function (resolve, reject) {
        exports.AsyncObtenerPermiso("ALUMNO", function (claveAlumno, error) {
            exports.AsyncObtenerPermiso("NORMAL", function (claveNormal, error) {
