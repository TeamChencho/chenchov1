class ConstructionGroup{
    ...
    loadComputer(){
        constructionComputer = this.scene.physics.add.sprite(
            0,
            0,
            "computer_01"
        )
        this.scene.aGrid.placeAtIndex(this.scene.constants.startPositionComputerConstruction,constructionComputer)
        Align.scaleToGameW(constructionComputer,.2)
        constructionComputer.y += 40 
    }
